defmodule SecantService.SecNodes.ParameterValueArrayDouble do
  use Ash.Resource,
  ...
  postgres do
    table "parameter_values_array_double"
  ...
  attributes do
    ...
    attribute :value, {:array, :float} do
      allow_nil? false
      public? true
    end
  ...
  relationships do
    belongs_to :parameter, SecantService.SecNodes.Parameter do
      allow_nil? false
